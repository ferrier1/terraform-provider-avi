...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"avi_seresourceproto":               dataSourceAviSeResourceProto(),
			"avi_seconsumerproto":               dataSourceAviSeConsumerProto(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"avi_seresourceproto":               resourceAviSeResourceProto(),
			"avi_seconsumerproto":               resourceAviSeConsumerProto(),
